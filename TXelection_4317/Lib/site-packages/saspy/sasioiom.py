...
class SASconfigIOM:
   ...
   def __init__(self, session, **kwargs):
      ...
      self.log4j     = cfg.get('log4j', '2.17.1')
      ...
      if self.classpath is None:
         ...
         log4j_prefixes = ("log4j-1.2-api-", "log4j-api-", "log4j-core-")
         log4j_paths = [delim + cpath + prefix + self.log4j + ".jar" for prefix in log4j_prefixes]
